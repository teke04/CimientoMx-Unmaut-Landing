            ...
            <div class="w-full max-w-[1140px] relative z-10 flex flex-col items-center">
                ...
                <div class="my-[80px] flex flex-col gap-y-[80px]">
                    ...
                    <div style="border-radius: 20px; background: rgba(80, 70, 150, 0.30); backdrop-filter: blur(5px);"
                        ...
                        <div class="size-[100px] p-[20px] absolute top-[-50px] left-1/2 -translate-x-1/2 bg-[#504696] rounded-[20px] group-hover:bg-[#282D7D] group-focus:bg-[#282D7D] transition-colors duration-300">
                    ...
                    <div class="flex flex-col lg:flex-row gap-[80px]">
                        ...
                        <div class="group px-[28px] lg:px-[60px] py-[80px] flex flex-col relative w-full gap-y-[40px] rounded-[20px] bg-[rgba(80,70,150,0.30)] backdrop-blur-[5px] hover:!bg-white focus:!bg-white transition-all duration-300 cursor-pointer" tabindex="0">
                            <div class="size-[100px] p-[20px] absolute top-[-50px] left-1/2 -translate-x-1/2 bg-[#504696] group-hover:bg-[#282D7D] group-focus:bg-[#282D7D] rounded-[20px] transition-colors duration-300">
